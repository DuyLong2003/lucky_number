...
router
  ...
  .get(auth(permission.USER.GET_USER), validate(userValidation.getUsers), userController.getUsers);

router.route('/reg').post(validate(userValidation.regUser), userController.regUser);

router.route('/change-password').patch(auth(), validate(userValidation.changePassword), userController.changePassword);
